...
const CONSENSI_ABBONAMENTO: { id: string; testo: string; link?: { label: string; href: string } }[] = [
  ...
  { id: "semaforo", testo: "Capisco che su BioFido il semaforo della filiera è facoltativo, ma per pubblicare un prodotto anche su ECO-VISA quel prodotto deve avere il semaforo (materie prime con la loro origine): i prodotti senza semaforo restano solo su BioFido." },
];
